...
using Empresa_All_Stars_Control_Alquiler.Models;

namespace Empresa_All_Stars_Control_Alquiler.Controllers
{
    public class Tipo_de_show_a_presentarController : Controller
    {
        private DBEventosEntities db = new DBEventosEntities();

        // GET: Tipo_de_show_a_presentar
        public ActionResult Index()
        {
            return View(db.Tipo_de_show_a_presentar.ToList());
        }

        // GET: Tipo_de_show_a_presentar/Details/5
        ...
        // GET: Tipo_de_show_a_presentar/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Tipo_de_show_a_presentar/Create
        ...
        // GET: Tipo_de_show_a_presentar/Edit/5
        ...
        // POST: Tipo_de_show_a_presentar/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: Tipo_de_show_a_presentar/Delete/5
        ...
        // POST: Tipo_de_show_a_presentar/Delete/5
